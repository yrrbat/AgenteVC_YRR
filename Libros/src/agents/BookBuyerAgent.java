...
public class BookBuyerAgent extends Agent {
  ...
  BookBuyerGui buyer = new BookBuyerGui();
  
 
  protected void setup() {
    buyer.setVisible(true);
    buyer.dialog("Buyer agent " + getAID().getName() + " is ready");
    Object[] args = getArguments();
    if(args != null && args.length > 0) {
      bookTitle = (String)args[0];
      buyer.dialogBuyer("Book: " + bookTitle);
  ...
  protected void takeDown() {
    buyer.dialogSeller("Buyer agent " + getAID().getName() + " terminating");
  }
